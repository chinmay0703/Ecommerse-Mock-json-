                    ...
                    <ul className="navbar-nav ml-auto d-block d-md-none justify-content-end">
                        <li className="nav-item">
                            {authToken ? (
                                ...
                                <Link className="btn btn-link" to="/cart"><i className="bx bxs-cart icon-single" ></i> <span className="badge bg-danger">{count}</span></Link>
                            ) : (

                                <Link className="btn btn-link" to="/cart"><i className="bx bxs-cart icon-single" ></i> <span className="badge bg-danger">0</span></Link>
                            )}
